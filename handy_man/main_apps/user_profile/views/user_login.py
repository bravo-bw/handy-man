...
from handy_man.main_apps.main.constants import IN_PROGRESS, COMPLETED, NEW, ARTISAN, CUSTOMER
from handy_man.main_apps.job.models import Job
from handy_man.main_apps.user_profile.models import UserProfile, Profession
from handy_man.main_apps.user_profile.forms import (AuthenticateForm, UserCreateForm, UserProfileForm)
