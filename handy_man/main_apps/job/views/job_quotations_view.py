...
from handy_man.main_apps.user_profile.classes import MenuConfiguration, UserRanking

from handy_man.main_apps.job.models import Quote, Job
from handy_man.main_apps.job.classes import QuoteHelper, JobHelper
from handy_man.main_apps.job.forms import QuotationForm
