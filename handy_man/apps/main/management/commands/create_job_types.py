...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Profession.objects.get_or_create(code='CP', profession_type='carpenter')
        Profession.objects.get_or_create(code='PL', profession_type='plumber')
        Profession.objects.get_or_create(code='EL', profession_type='electrician')
        Profession.objects.get_or_create(code='BL', profession_type='brick_layer')
        Profession.objects.get_or_create(code='TL', profession_type='tiler')
